...
class L10nBrDiDeclaracao(models.Model):
    ...
    def _importa_declaracao(self, declaracoes):
        ...
        vals = {
            ...
            "data_registro_icms": di.data_registro_icms,
            "hora_registro_icms": di.hora_registro_icms,
            "nome_tipo_recolhimento_icms": di.nome_tipo_recolhimento_icms,
            "numero_sequencial_icms":di.numero_sequencial_icms,
            "uf_icms": di.uf_icms,
            "valor_total_icms": di.valor_total_icms,
